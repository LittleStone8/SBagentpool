...
这里我要吐槽一下了，受到网上一些烂大街的爬代理示例代码的影响，同学们总是孜孜不倦的一次次的爬人家的代理网站，频率太高了，谁抗的住啊，不反你爬反谁爬，不封你IP封谁IP。其实他们是没有看了我这篇文章，这个项目，如果看了的话，他们就会知道，爬代理最重要的不在于爬取，而在于管理。反正我的项目的频率是一个小时才去爬取一次
话说回来，最安全的肯定是优先使用代理去抓取代理嘛。<br>
